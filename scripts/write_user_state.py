...
path = os.path.expanduser('~/bonusvarsel/lib/services/user_state.dart')
...
import subprocess
checks = ['getSelectedCardIds', 'addSelectedCard', 'removeSelectedCard',
          'isTrumfMember', 'getEurobonusPoints', 'getFavorites']
all_ok = True
for c in checks:
...
print()
print("✅ user_state.dart oppdatert" if all_ok else "❌ Noe gikk galt")
