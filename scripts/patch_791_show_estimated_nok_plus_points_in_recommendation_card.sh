...
echo "==> patch_791_show_estimated_nok_plus_points_in_recommendation_card"
...
cp "$WIDGET" "$WIDGET.bak_791_$(date +%Y%m%d_%H%M%S)"
echo "✅ Backup laget"
...
class SmartBestRecommendationCard extends StatelessWidget {
  ...
  static const double _nokPerPoint = 0.10; // konservativ ca.-verdi i UI
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      _chip(
                        text: uplift > 0 ? '+${upliftNok} kr ekstra' : 'Standard',
...
echo
echo "==> Verifisering"
grep -n "_nokPerPoint\|Ca. .* kr\|0,10 kr per poeng" "$WIDGET" || true
