...
cat > ~/bonusvarsel/lib/pages/travel_page.dart << 'DART'
            ...
            _sectionCard(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: _counterWidget('Voksne', _adults,
                        onMinus: _adults > 1 ? () => setState(() => _adults--) : null,
                        onPlus: () => setState(() => _adults++))),
                      const SizedBox(width: 12),
                      Expanded(child: _counterWidget('Barn (under 12)',  _children,
              ...
              child: Column(
                children: [
                  ...
                  if (_currentPoints > 0 && _estimatedPoints > 0) ...[
                    ...
                    const Divider(),
                    _pointsSummaryRow('Mulig saldo etter kjøp', _pointsAfter,
...
echo "✅ Ny travel_page bygget med komplett flyt"
