...
# 1) Legg til intervall-variabel rett under monitorIntervalMs-linjen
...
# 2) Legg til scheduler-block (som ren fil-append via python for å unngå perl-interpolasjonsproblemer med $)
python3 << 'PYEOF'
import re
