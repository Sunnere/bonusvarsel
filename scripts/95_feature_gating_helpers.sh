...
FILE="lib/app/feature_gating.dart"
...
class FeatureGating {
  ...
  static bool isGated({
    ...
    return !isPremium && total > visibleCount(isPremium: isPremium, freeLimit: freeLimit, total: total);
  }
}
DART

dart format "$FILE"
echo "✅ 3) Feature gating helper lagt til: $FILE"
