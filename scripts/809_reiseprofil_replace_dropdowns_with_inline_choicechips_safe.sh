...
echo "==> 809_reiseprofil_replace_dropdowns_with_inline_choicechips_safe"
...
bak = path.with_name(path.name + f".bak_{stamp}_809")
...
if old not in text:
    print("❌ Fant ikke eksakt blokk for Reiseprofil-valgene")
    print("Kjør og send:")
...
print("✅ 809 ferdig: popup-dropdowns i Reiseprofil er erstattet med inline ChoiceChips")
PY
