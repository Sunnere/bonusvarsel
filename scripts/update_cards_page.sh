#!/bin/bash
cp lib/pages/cards_page.dart lib/pages/cards_page.dart.bak
...
class _CardsPageState extends State<CardsPage> {
  ...
  static const _cards = [
    _CardInfo(
      ...
      url: 'https://www.saseurobonuscard.no',
      badge: 'Mest poeng',
    ),
    _CardInfo(
      id: 'sas_mc',
    ...
    _CardInfo(
      ...
      url: 'https://www.trumf.no/trumf-visa',
      badge: 'Trumf',
    ),
    _CardInfo(
      id: 'trumf_mc',
...
echo "✅ cards_page.dart oppdatert"
echo "   - Alle 5 kort vises med navn, rate, farge og beskrivelse"
echo "   - Velg kort lagres til UserState (brukes av Reise-siden)"
echo "   - Se kort-knapp åpner kortets nettside"
echo "   - Aktivt kort vises øverst i hero"
echo "   - Backup lagret som cards_page.dart.bak"
