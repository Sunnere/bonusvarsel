...
BACKUP="${FILE}.bak_953_make_checkout_page_real_iap_$(date +%Y%m%d_%H%M%S)"
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Text(
                        'Betaling fullføres i appen via Apple. Du blir ikke sendt til en ekstern nettside.',
                        style: TextStyle(
...
echo "✅ Erstattet checkout_page.dart med ekte Apple IAP-flyt"
