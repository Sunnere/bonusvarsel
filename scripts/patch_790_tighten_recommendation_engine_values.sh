...
TARGET="lib/services/bonus_recommendation_engine.dart"

echo "==> patch_790_tighten_recommendation_engine_values"
...
cp "$TARGET" "$TARGET.bak_790_$(date +%Y%m%d_%H%M%S)"
echo "✅ Backup laget"
...
echo
echo "==> Verifisering"
grep -n "_capEstimatedPoints\|_capUplift\|Ca. +\\$uplift poeng mot standardvalg" "$TARGET" || true
