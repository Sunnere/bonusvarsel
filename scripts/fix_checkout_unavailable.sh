#!/bin/bash
# Fikser at CheckoutPage sender bruker tilbake når produkt ikke er tilgjengelig.
# I stedet for å disable knappen, vis en klar feilmelding og la bruker prøve på nytt.

cp lib/pages/checkout_page.dart lib/pages/checkout_page.dart.bak

cat > lib/pages/checkout_page.dart << 'DART'
...
echo "✅ checkout_page.dart oppdatert"
echo "   - Knappen er alltid synlig og klikkbar"
echo "   - Ved manglende produkt: auto-retry før feilmelding"
echo "   - Loading-state viser spinner med tekst"
echo "   - Backup lagret som checkout_page.dart.bak"
