...
FILE="$HOME/bonusvarsel/lib/services/checkout_service.dart"

# Legg til navigator callback i CheckoutService
# og oppdater _onPurchaseUpdate til å kalle den
...
echo "✅ checkout_service.dart oppdatert med onPurchaseSuccess callback"
