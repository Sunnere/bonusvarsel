...
cat > ~/bonusvarsel/functions/index.js << 'JS'
...
mkdir -p ~/bonusvarsel/functions/keys
echo "✅ Firebase Function for Promotional Offer signering er klar"
echo ""
echo "⚠️  Neste steg: Kopier .p8-filen til ~/bonusvarsel/functions/keys/SubscriptionKey.p8"
